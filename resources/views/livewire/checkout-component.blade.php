        ...
        <div class=" main-content-area">
                                ...
                                <label class="col-md-4 control-label">Country</label>                        
                                    <select class="form-control" wire:model="country" >
                                        ...
                                        @foreach ($countries as $country)
                                            <option value="{{$country->distance}}">{{$country->name}}</option>
                                        @endforeach
                                    </select>
                            </p>
            ...
            <div class="summary summary-checkout">
                <div class="summary-item payment-method">
                    ...
                    <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">${{Session::get('checkout')['total'] +$harga_ongkir }} </span></p>
                    @endif
                ...
                <div class="summary-item shipping-method">
                    ...
                    <p class="row-in-form">                                                
                                    <select class="form-control" wire:model="kurir" wire:change="setShippingCharge" >
                                        <option value="0">Select expedition</option>
                                        @foreach ($expeditions as $expedition)
                                            <option value="{{$expedition->price_km}}">{{$expedition->kurir}}</option>
                                        @endforeach
                                    </select>
                            </p>
                    <p class="summary-info"><span class="title">Flat Rate</span></p>
                    @if($harga_ongkir)
                    <p class="summary-info"><span class="title">Fixed ${{$harga_ongkir}}</span></p>
                    @else
