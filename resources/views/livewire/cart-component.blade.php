                    ...
                    <!-- mouse -->
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="/product/msi-gaming-mouse-m88" title="Msi M88 Gaming mouse">
                                    <figure><img src="{{ asset('assets/images/products/mousem88.jpg') }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>Msi M88 Gaming mouse</span></a>
                                <div class="wrap-price"><span class="product-price">$12.00</span></div>
                            </div>
                        </div>
                        <!-- mousepad -->
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="/product/msi-xield-5" title="Mousepad gaming Msi Xield 5">
                                    <figure><img src="{{ asset('assets/images/products/1668406177.jpg') }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="group-flash">
                            ...
                            <div class="product-info">
                                <a href="/product/msi-xield-5" class="product-name"><span>Mousepad gaming Msi Xield 5</span></a>
                                <div class="wrap-price"><ins><p class="product-price">$15.00</p></ins> <del><p class="product-price">$20.00</p></del></div>
                            </div>
                        </div>
                    <!-- msi mag force -->
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="/product/msi-mag-forge-100r" title="Msi mag force 100r">
                                    <figure><img src="{{ asset('assets/images/products/1668410016.jpg') }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="group-flash">
                                    <span class="flash-item new-label">new</span>
                                    <span class="flash-item sale-label">sale</span>
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>Msi mag force 100r</span></a>
                                <div class="wrap-price"><ins><p class="product-price">$15.00</p></ins> <del><p class="product-price">$35.00</p></del></div>
                            </div>
                        </div>

                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="/product/gtx-1660-super-msi" title="Gtx 1660 Super gming X">
                                    <figure><img src="{{ asset('assets/images/products/1668410664.jpg') }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="group-flash">
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>Gtx 1660 Super gming X</span></a>
                                <div class="wrap-price"><span class="product-price">$159.00</span></div>
                            </div>
                        </div>

                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="/product/msi-optix-g241" title="Monitor Msi optix g241">
                                    <figure><img src="{{ asset('assets/images/products/1668478432.jpg') }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="wrap-btn">
                                    <a href="#" class="function-link">quick view</a>
                                </div>
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>Monitor Msi optix g241</span></a>
