        ...
        <header id="header" class="header header-style-1">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="container">
                        <div class="mid-section main-info-area" style="background:white">

                            <div class="wrap-logo-top left-section">
                                <a href="index.html" class="link-to-home"><img src="{{ asset('assets/images/msi-logo.png') }}" alt="mercado"></a>
                            </div>
